...
//            }
    ...
    public static boolean setStatusBarLightMode(Activity activity) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            if (isCustomStatusBarLightModeImpl() && SetStatusBarLightMode(activity.getWindow(), true)) {
    ...
    private static boolean setStatusBarLightMode(Activity activity, @StatusBarType int type) {
        if (type == STATUSBAR_TYPE_MIUI) {
            return SetStatusBarLightMode(activity.getWindow(), true);
    ...
    public static boolean setStatusBarDarkMode(Activity activity) {
        ...
        if (mStatuBarType == STATUSBAR_TYPE_MIUI) {
            return SetStatusBarLightMode(activity.getWindow(), false);
     ...
     */
    private static boolean isCustomStatusBarLightModeImpl() {
